...
export const STRINGS_ES = {
    ...
    settings: {
        headings: {
            ...
            resizeThumbnail: 'Redimensionar miniatura',
        ...
        items: {
            ...
            resizeFeatureImage: {
                ...
                desc: 'Redimensionar imagen destacada para mejor rendimiento en listas desplazables.'
            },
            ...
            frontmatterImageSourceProperties: {
                name: 'Propiedades de origen de imagen en frontmatter',
                desc: 'Lista separada por comas de propiedades de frontmatter para buscar rutas/URLs de imágenes antes de escanear el documento. Admite cadenas y listas YAML.'
            },
            onlyUpdateExisting: {
    ...
    errors: {
        httpImageLinkIgnored: (filePath: string, url: string, source?: string) =>
            `Enlace de imagen HTTP${source ? ` ${source}` : ''} ignorado en ${filePath}: ${url}. Featured Image solo procesa enlaces HTTPS; actualiza el enlace a HTTPS.`
    }
};
